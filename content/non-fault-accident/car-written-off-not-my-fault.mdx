...
faq:
  ...
  - q: "Do I lose my no-claims bonus if my car is written off in a non-fault accident?"
    a: "If the claim is handled through the at-fault driver’s insurer and nothing goes through your own policy, your [no-claims bonus](/will-a-non-fault-accident-affect-my-insurance/) is not affected and your excess is not triggered."
---
...
While the write-off is being processed, you are entitled to a [replacement vehicle](/non-fault-accident-courtesy-car/). It should be [like-for-like](/non-fault-accident-courtesy-car/) m, in other words it should be the same size and type as the car you have lost and the hire period should cover the reasonable time needed to settle the claim and source a replacement. We arrange this as part of the same process.
