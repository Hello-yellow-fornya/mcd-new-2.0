...
- **Lockups:** `claims247-logo-on-light`, `-on-light-yellow`, `-on-cream`, `-on-yellow`, `-on-ink`, `-mono-ink`, `-mono-white` (640×200 frame). **Rule: "Claims" takes the wordmark colour; "247" takes the accent**: ochre on light and cream, yellow on light-yellow and on ink, ink on yellow, the wordmark colour in the monos.
