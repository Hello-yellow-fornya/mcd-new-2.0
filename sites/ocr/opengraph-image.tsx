      ...
      <div style={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', justifyContent: 'space-between', background: '#F4F6F5', color: '#0E2A47', padding: 72, fontFamily: 'Inter' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <div style={{ display: 'flex', marginTop: 12 }}>
            <span style={{ display: 'flex', backgroundImage: 'linear-gradient(transparent 55%, #DDF5EB 55%)', color: '#0E2A47', fontWeight: 900, fontSize: 100, lineHeight: 1.05, letterSpacing: -4 }}>Report it here.</span>
          </div>
