...
/** Claims Report Line (claimsreportline.co.uk; the site id and API source stay "ocr"): the same company and claims API as Claims 24/7, a third door where the accident is reported online, whoever was at fault. */
export const siteConfig = {
  id: 'ocr',
  name: 'Claims Report Line',
  legalName: 'Motor Claims Department Ltd',
  /** [TODO] blocking placeholder until the client confirms the entity line. */
  legalLine: 'Motor Claims Department Ltd, trading as Claims Report Line',
